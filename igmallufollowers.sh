C #!/bin/bash
# igmallufollowers v1.0
# recoded by: HASAN
# github.com/hopeleskid/igmallufollowers-bot
...
printf " \e[1;31m                                    
\e[0m\n"
printf " \e[1;31m  ___   _______  __   __  _______  ___      ___      __   __  _______  _______  ___      ___      _______  _     _  _______  ______    _______ \e[0m\n"
printf " \e[1;31m |   | |       ||  |_|  ||   _   ||   |    |   |    |  | |  ||       ||       ||   |    |   |    |       || | _ | ||       ||    _ |  |       |\e[0m\n"
printf " \e[1;31m |   | |    ___||       ||  |_|  ||   |    |   |    |  | |  ||    ___||   _   ||   |    |   |    |   _   || || || ||    ___||   | ||  |  _____|\e[0m\n"
printf " \e[1;31m |   | |   | __ |       ||       ||   |    |   |    |  |_|  ||   |___ |  | |  ||   |    |   |    |  | |  ||       ||   |___ |   |_||_ | |_____ \e[0m\n"
printf " \e[1;31m |   | |   ||  ||       ||       ||   |___ |   |___ |       ||    ___||  |_|  ||   |___ |   |___ |  |_|  ||       ||    ___||    __  ||_____  |\e[0m\n"
printf " \e[1;31m |   | |   |_| || ||_|| ||   _   ||       ||       ||       ||   |    |       ||       ||       ||       ||   _   ||   |___ |   |  | | _____| |\e[0m\n"
printf " \e[1;31m |___| |_______||_|   |_||__| |__||_______||_______||_______||___|    |_______||_______||_______||_______||__| |__||_______||___|  |_||_______|\e[0m\n"                                                                                                                                                   \e[0m\n"                                                                   \n"
printf "\n"

printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded by hasan (hopeleskid2.0) (thanks to cyberkallan )\e[0m\n"
}
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] This technique consists of following/unfolling teams\e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] It can increase your followers up to about +100 in 1 hour \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Press Ctrl + C to stop \e[0m\n"
sleep 5

username_id=$(curl -L -s 'https://www.instagram.com/'$user'' > getid && grep -o  'profilePage_[0-9]*.' getid | cut -d "_" -f2 | tr -d '"')

team__haash="43851563051"
team_kalimayam="28962501508"
insta_squadron="33495219680"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;77m Sleeping 432 secs...\e[0m\n"
sleep 432
#unfollow
for celeb in $(cat celeb_id); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
